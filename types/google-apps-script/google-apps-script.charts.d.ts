...
declare namespace Charts {
   ...
   * documentation
   */
  interface CategoryFilterBuilder {
    build(): Control;
   ...
   * documentation.
   */
  interface DashboardPanelBuilder {
 ...
 *     }
 */
declare interface Charts {
  ChartHiddenDimensionStrategy: typeof Charts.ChartHiddenDimensionStrategy;
  ChartMergeStrategy: typeof Charts.ChartMergeStrategy;
  ChartType: typeof Charts.ChartType;
  ColumnType: typeof Charts.ColumnType;
  CurveStyle: typeof Charts.CurveStyle;
  MatchType: typeof Charts.MatchType;
  Orientation: typeof Charts.Orientation;
  PickerValuesLayout: typeof Charts.PickerValuesLayout;
  PointStyle: typeof Charts.PointStyle;
  Position: typeof Charts.Position;
  newAreaChart(): Charts.AreaChartBuilder;
  newBarChart(): Charts.BarChartBuilder;
  newCategoryFilter(): Charts.CategoryFilterBuilder;
  newColumnChart(): Charts.ColumnChartBuilder;
  newDashboardPanel(): Charts.DashboardPanelBuilder;
  newDataTable(): Charts.DataTableBuilder;
  newDataViewDefinition(): Charts.DataViewDefinitionBuilder;
  newLineChart(): Charts.LineChartBuilder;
  newNumberRangeFilter(): Charts.NumberRangeFilterBuilder;
  newPieChart(): Charts.PieChartBuilder;
  newScatterChart(): Charts.ScatterChartBuilder;
  newStringFilter(): Charts.StringFilterBuilder;
  newTableChart(): Charts.TableChartBuilder;
  newTextStyle(): Charts.TextStyleBuilder;
}
