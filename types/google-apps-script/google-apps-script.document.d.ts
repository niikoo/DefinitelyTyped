...
declare namespace Document {
  ...
  interface Document {
    ...
    addNamedRange(name: string, range: DocumentRange): NamedRange;
    ...
    setSelection(range: DocumentRange): Document;
  }
  ...
  interface RangeBuilder {
    ...
    addRange(range: DocumentRange): RangeBuilder;
    build(): DocumentRange;
    getRangeElements(): RangeElement[];
    getSelectedElements(): RangeElement[];
  }
...
declare const DocumentApp: Document.DocumentApp;
