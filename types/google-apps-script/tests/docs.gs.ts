...
/**
 * Source: https://raw.githubusercontent.com/gsuitedevs/apps-script-samples/master/docs/cursorInspector/cursorInspector.gs
 */
 ...
 */
function getElementInfo(element: Document.Element): { type: string } {
    return {
