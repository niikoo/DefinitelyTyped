// Type definitions for google-apps-script-oauth2 24.1
...
declare namespace GoogleAppsScriptOAuth2 {
    ...
    interface OAuth2Service {
         ...
         */
        setCache(cache: Cache.Cache): OAuth2Service;
        /**
         ...
         */
        setPropertyStore(propertyStore: Properties.Properties): OAuth2Service;
        /**
